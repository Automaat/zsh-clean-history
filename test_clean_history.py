...
class TestLoadExitCodes(unittest.TestCase):
    ...
    def test_load_valid_exit_codes(self) -> None:
    ...
    def test_load_invalid_exit_codes(self) -> None:
...
class TestIntegration(unittest.TestCase):
    ...
    def test_failed_command_similarity(self) -> None:
    ...
    def test_failed_command_exact_match_not_removed(self) -> None:
    ...
    def test_failed_prefix_removed(self) -> None:
